...
def create_test_data():
    ...
    print(
        f"✅ Created appointment {appointment.id} with therapist {therapist.username}"
    )
    ...
    for test_case in test_cases:
        ...
        if test_case["expected_error"]:
            ...
            if (
                ...
                and test_case["expected_error"] in response_data["error"]
            ):
                print(f"   ✅ Expected error message found: {response_data['error']}")
            else:
                print(
                    f"   ❌ Expected error message not found. Response: {response_data}"
                )
        else:
            ...
            if appointment.status == "rejected":
                ...
                print(
                    f"   ❌ Appointment status not updated. Current status: {appointment.status}"
                )

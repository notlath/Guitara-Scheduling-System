...
describe("Real-time Availability Sync Tests", () => {
  ...
  beforeEach(() => {
    ...
    const SyncService =
      require("../royal-care-frontend/src/services/syncService.js").default;
  ...
  test("Sync events trigger Redux reducers", () => {
    ...
    const mockSyncActions = {
      syncAvailabilityCreated: vi.fn((payload) => ({
        type: "syncAvailabilityCreated",
        payload,
      })),
      syncAvailabilityUpdated: vi.fn((payload) => ({
        type: "syncAvailabilityUpdated",
        payload,
      })),
      syncAvailabilityDeleted: vi.fn((payload) => ({
    ...
    syncService.subscribe("availability_deleted", (data) => {
      dispatchSpy(
        mockSyncActions.syncAvailabilityDeleted({
          id: data.id,

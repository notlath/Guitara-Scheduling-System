...
def check_route_configuration():
    ...
    try:
        ...
        if os.path.exists("royal-care-frontend/src/components/scheduling/AvailabilityManager.jsx"):
...
def check_import_statements():
    ...
    try:
        ...
        if 'import AvailabilityManager from "./components/scheduling/AvailabilityManager";' in app_content:
...
def generate_test_summary():
    ...
    print("- The route is nested under /dashboard, so full path is /dashboard/availability")
    print()
    print("FIX APPLIED:")
    print("- Changed navigate('/availability') to navigate('availability') in OperatorDashboard.jsx")
    ...
    print("- Clicking 'Manage Availability' in OperatorDashboard should navigate to /dashboard/availability")

...
def main():
    ...
    for client in existing_clients[:10]:  # Show first 10
        print(
            f"  - {client.first_name} {client.last_name} ({client.phone_number}) - Email: {client.email}"
        )
    ...
    if existing_clients.count() == 0:
        ...
        for client_data in test_clients:
            ...
            print(
                f"✅ Created client: {client_data['first_name']} {client_data['last_name']}"
            )
        ...
        for term in search_terms:
            ...
            ) | Client.objects.filter(last_name__icontains=term)

...
os.environ["ALLOWED_HOSTS"] = "charismatic-appreciation-production.up.railway.app,localhost,127.0.0.1"
...
try:
    ...
    problem_domain = "https://guitara-scheduling-system-git-main-lathrells-projects.vercel.app"

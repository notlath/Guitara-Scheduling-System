...
def start_django():
    ...
    try:
        ...
        print_colored("✅ Django ASGI server started on http://127.0.0.1:8000", Colors.GREEN)
        print_colored("📡 WebSocket endpoint: ws://127.0.0.1:8000/ws/scheduling/appointments/", Colors.CYAN)
...
def start_frontend():
    ...
    try:
        ...
        print_colored("✅ React frontend started on http://localhost:5173", Colors.GREEN)
...
def main():
    ...
    print_colored("🔧 Backend API: http://127.0.0.1:8000/api/", Colors.GREEN + Colors.BOLD)
    print_colored("📡 WebSocket: ws://127.0.0.1:8000/ws/scheduling/appointments/", Colors.GREEN + Colors.BOLD)
    ...
    print_colored("   • Check the browser console for WebSocket connection status", Colors.CYAN)
    print_colored("   • Real-time updates should work across multiple tabs/devices", Colors.CYAN)

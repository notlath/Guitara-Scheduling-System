...
def test_check_account_status():
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            print(f"✓ Account '{result['username']}' is {'active' if result['is_active'] else 'disabled'}")
...
def simulate_account_status_polling():
    ...
    print("Simulating account status polling (checking every 5 seconds for 30 seconds)...")

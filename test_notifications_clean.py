    ...
    try:
        ...
        if response.status_code == 200:
            ...
            if notifications:
                ...
                # Test mark as read
                response = requests.post(f"{base_url}/notifications/{notif_id}/mark-read/", headers=headers)
                print(f"POST /notifications/{notif_id}/mark-read/ - Status: {response.status_code}")
                
                # Test mark as unread
                response = requests.post(f"{base_url}/notifications/{notif_id}/mark-unread/", headers=headers)
                print(f"POST /notifications/{notif_id}/mark-unread/ - Status: {response.status_code}")

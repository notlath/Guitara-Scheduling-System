...
import { useRejectionModal, useMaterialModal } from "../hooks/useModalState";
...
const TherapistDashboard = () => {
  ...
  // ✅ REFACTORED: Use common modal hooks
  const {
  ...
  // ✅ REMOVED: Duplicate variable declarations - now using common dashboard hook

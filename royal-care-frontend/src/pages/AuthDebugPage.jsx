...
// Import functions directly with correct path
import { debugTokenStatus, getToken } from "../utils/tokenManager";
  ...
  const testApiCall = async () => {
    ...
    try {
      const response = await fetch(
        "http://localhost:8000/api/system-logs/?log_type=auth&page=1&page_size=5",
        {
          headers: {

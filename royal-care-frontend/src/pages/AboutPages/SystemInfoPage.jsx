          ...
          <div className="tech-stack">
            <div className="stack-group">
              ...
              <ul>
                ...
                <li>
                  <span className="tech-label">Routing:</span> React Router 6.22
                </li>
                <li>
                  <span className="tech-label">API Client:</span> Axios
                </li>
                <li>
                  <span className="tech-label">UI Components:</span> Custom CSS
                  with React Icons
                </li>
              </ul>
            </div>
            <div className="stack-group">
              ...
              <ul>
                ...
                <li>
                  <span className="tech-label">API:</span> Django REST Framework
                </li>
                <li>
                  <span className="tech-label">Database:</span> PostgreSQL 17.2
                </li>
                <li>
          ...
          <div className="architecture">
            <div className="architecture-item">
              ...
              <p>
                ...
                feature and functionality. Redux manages application state while

    ...
    for endpoint in endpoints_to_test:
        ...
        try:
            ...
            if status_ok:
                ...
                results.append({"endpoint": endpoint['name'], "status": "PASS", "code": response.status_code})
            else:
                print(f"   ❌ Status: {response.status_code} (Expected: {expected})")
                results.append({"endpoint": endpoint['name'], "status": "FAIL", "code": response.status_code})

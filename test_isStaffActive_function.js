...
const isStaffActive = (staff) => {
  ...
  console.log(`🔍 isStaffActive check for ${staff.first_name} ${staff.last_name}:`, {
    rawValue: isActive,
  ...
  if (typeof isActive === 'string') {
    ...
    const result = lowerValue === 'true' || lowerValue === '1' || lowerValue === 'yes' || lowerValue === 'active';
...
// Test cases
const testCases = [
  { id: 1, first_name: "John", last_name: "Doe", is_active: true, expected: true },
  { id: 2, first_name: "Jane", last_name: "Smith", is_active: false, expected: false },
  { id: 3, first_name: "Bob", last_name: "Johnson", is_active: "true", expected: true },
  { id: 4, first_name: "Alice", last_name: "Brown", is_active: "false", expected: false },
  { id: 5, first_name: "Charlie", last_name: "Wilson", is_active: 1, expected: true },
  { id: 6, first_name: "Diana", last_name: "Davis", is_active: 0, expected: false },
  { id: 7, first_name: "Eve", last_name: "Miller", is_active: undefined, expected: true },
  { id: 8, first_name: "Frank", last_name: "Garcia", is_active: null, expected: true },
  { id: 9, first_name: "Grace", last_name: "Martinez", is_active: "1", expected: true },
  { id: 10, first_name: "Henry", last_name: "Anderson", is_active: "0", expected: false },
];
...
if (failCount === 0) {
  console.log("🎉 All tests passed! The isStaffActive function handles all data types correctly.");
} else {

...
class Availability(models.Model):
    ...
    def clean(self):
        ...
        if self.user.role not in ['therapist', 'driver']:
            raise ValidationError("Only therapists and drivers can have availability slots")
...
class Appointment(models.Model):
    ...
    services = models.ManyToManyField('registration.Service', related_name='appointments')
    ...
    notes = models.TextField(blank=True, null=True)
    required_materials = models.TextField(blank=True, null=True, help_text="Materials needed for this appointment")

...
class LogsResultsPagination(PageNumberPagination):
    """
    Pagination class optimized for logs display
    """

    page_size = 10  # Lower page size for logs to improve loading speed
    page_size_query_param = "page_size"
    max_page_size = 100  

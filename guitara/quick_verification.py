...
def quick_test():
    ...
    try:
        ...
        print(
            f"✅ Users in system: {operator_count} operators, {therapist_count} therapists, {driver_count} drivers"
        )
        ...
        if therapist_count > 0 and appointment_count > 0:
            ...
            if response.status_code == 404:
                ...
                print(
                    f"✅ start_session endpoint accessible (status: {response.status_code})"
                )
